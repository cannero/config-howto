...
#+begin_src emacs-lisp :tangle yes :comments org
  ...
  (defun my-rustic-mode-hook ()
    ...
    ;; TODO: for servo add to ia0?
    ;;(setq lsp-rust-analyzer-cargo-override-command [".\\mach.bat" "check" "--message-format=json" "--target-dir=target/lsp"]))
