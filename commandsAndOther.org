...
** fonts
   ...
   todo! remove colors, otherwise they overwrite themes
...
otherwise list-processes, use process name as argument to kill process
...
** commands
   ...
   - cherry-pick
   - remove changes in all tracked files git checkout -f
